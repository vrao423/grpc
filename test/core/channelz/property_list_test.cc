...
TEST(PropertyListTest, Merge) {
  ...
  EXPECT_EQ(size, 4);
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyList_Element_key(props[0])),
            "key1");
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyValue_string_value(
                    grpc_channelz_v2_PropertyList_Element_value(props[0]))),
            "value1");
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyList_Element_key(props[1])),
            "key2");
  EXPECT_EQ(grpc_channelz_v2_PropertyValue_int64_value(
                grpc_channelz_v2_PropertyList_Element_value(props[1])),
            123);
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyList_Element_key(props[2])),
            "key2");
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyValue_string_value(
            ...
            "new_value");
  EXPECT_EQ(UpbStringToStdString(
                grpc_channelz_v2_PropertyList_Element_key(props[3])),
            "key3");
